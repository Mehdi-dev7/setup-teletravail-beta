	...
	const faqJsonLd = {
		...
		mainEntity: [
			...
			},
			{
				...
				acceptedAnswer: {
					"@type": "Answer",
					text: `Le ${ecran.nom} se distingue par : ${ecran.pointsForts[0]}. Avec un temps de réponse de ${ecran.tempsReponse}, une fréquence de ${ecran.frequence} et un prix de ${ecran.prix}€, il offre un excellent rapport qualité-prix.`,
				},
			},
		],
	};
					...
					<div className="bg-white border border-gray-200 rounded-2xl p-3 sm:p-6 md:p-8">
						...
						<div className="space-y-6">
							...
							<div>
								...
								<p className="text-gray-700 text-base leading-relaxed">
									Le {ecran.nom} se distingue par : {ecran.pointsForts[0]}. Avec un temps de réponse de {ecran.tempsReponse}, une fréquence de {ecran.frequence} et un prix de {ecran.prix}€, il offre un excellent rapport qualité-prix pour le télétravail.
								</p>
							</div>
						</div>
					</div>
