...
export default function TapisSourisDetails() {
	const params = useParams<{ slug: string }>();
	const id = params?.slug || "";

	// Recherche dans tous les tapis
		...
		<>
			...
			<div className="section-bg text-white flex flex-col">
				...
				<div className="flex flex-wrap items-center text-base sm:text-xl mt-3 gap-1">
					...
					<Link href="/accessoires/tapisSouris" className="hover:text-(--prim) transition-all duration-300">
						Tapis de Souris
					</Link>
					<i className="ri-arrow-right-wide-fill mt-1"></i>
