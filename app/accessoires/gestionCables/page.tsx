...
export default function GestionCables() {
	return (
		<>
			<div className="section-bg text-white flex flex-col">
				...
				<div className="flex items-center text-xl mt-3">
					...
					<h2 className="GolosText">Gestion Câbles</h2>
				</div>
			</div>
			...
			<div className="px-4 sm:px-[8%] lg:px-[12%] py-20">
				...
				<div className="max-w-4xl mb-16">
					...
					<h2 className="Sora text-4xl sm:text-5xl md:text-5xl 2xl:text-6xl  mb-5 leading-tight my-4 sm:my-5">
						Les meilleures solutions de{" "}
						<span className="text-(--prim)">gestion de câbles</span>
					</h2>
					<p className="md:text-lg text-base text-gray-600 leading-relaxed mb-4">
						Découvrez notre sélection des meilleures solutions pour organiser et cacher
						vos câbles. Un bureau bien rangé améliore la productivité et l&apos;esthétique
						de votre espace de travail. Des{" "}
						<strong>boîtes cache-multiprises</strong> aux{" "}
						<strong>goulottes adhésives</strong>, en passant par les{" "}
						<strong>chemins de câbles sous bureau</strong>.
					</p>
					<p className="text-lg text-gray-600 leading-relaxed">
						Que vous cherchiez une solution premium design, un système économique
						ou des clips pratiques, vous trouverez ici la solution idéale pour
						un bureau impeccable.
					</p>
				</div>

				{/* Section Rangements Câbles */}
				<div className="mb-20">
						...
						<div className="flex flex-col flex-1">
							<div className="flex items-center justify-between">
								...
								<span className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm">
									{GestionCableData.rangements_cables.length} produits
								</span>
							</div>
							<span className="text-base md:text-lg text-gray-500 mt-1">
								Organisez et cachez vos câbles efficacement
							</span>
						</div>
					</div>

					<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
						{GestionCableData.rangements_cables.map((item, index) => (
							<Link href={`/accessoires/gestionCables/${item.id}`} key={item.id}>
